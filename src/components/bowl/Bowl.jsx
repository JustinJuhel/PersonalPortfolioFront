        ...
        <div className='bowl-container' style={{ width: diameter + "rem" }}>
            <div className='bowl'>
                <svg className="white-stroke" width="717" height="717" viewBox="0 0 717 717" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <defs>
                        <filter id="filter0_f_53_698" x="-150.151" y="0.918274" width="1000" height="717" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
                ...
                <svg className='first-form form' xmlns="http://www.w3.org/2000/svg" width="717" height="552" viewBox="0 0 717 552" fill="none">
                    ...
                    <defs>
                        <filter id="filter0_f_53_697" x="-150.151" y="0.918274" width="982.381" height="550.947" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
                            <feFlood floodOpacity="0" result="BackgroundImageFix" />
                            <feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape" />
                ...
                <svg className='second-form form' xmlns="http://www.w3.org/2000/svg" width="717" height="717" viewBox="0 0 717 717" fill="none">
                    ...
                    <defs>
                        <filter id="filter0_f_53_696" x="-134" y="-60" width="947" height="821.513" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
